...
def get_top_movie_by_genre(all_genres,all_movies,all_ratings):
    ...
    if all_genres and all_movies and all_ratings and len(all_genres) and len(all_movies) and len(all_ratings):
...
def get_ratings_dict(all_ratings):
    ...
    if all_ratings and len(all_ratings):
        rating_dict = {}
...
def most_watched_movie(all_movies,all_ratings):
    ...
    if all_movies and all_ratings and len(all_movies) and len(all_ratings):
        users_rating_dict = {}
        for rating in all_ratings:
